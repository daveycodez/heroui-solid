...
```tsx file=../../../demos/chip/basic.tsx title=""
...
```tsx file=../../../demos/chip/variants.tsx title=""
...
```tsx file=../../../demos/chip/with-icon.tsx title=""
...
```tsx file=../../../demos/chip/statuses.tsx title=""
...
| ---------- | ----------------------------------------------------------- | ------------- | -------------------------------------- |
| `children` | `JSX.Element`                                               | -             | Content to display inside the chip     |
...
| Prop       | Type             | Default  | Description                            |
| ---------- | ---------------- | -------- | -------------------------------------- |
| `children` | `JSX.Element`    | -        | Label text content                     |
| `as`       | `ValidComponent` | `"span"` | Overrides the rendered element (Kobalte polymorphic). |
| `class`    | `string`         | -        | Additional CSS classes for the label slot |
