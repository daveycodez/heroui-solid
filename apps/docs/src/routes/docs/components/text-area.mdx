...
For validation, wrap the TextArea in a [TextField](/docs/components/text-field). The field stamps `data-invalid` on the TextArea and renders the `FieldError`.

<ComponentPreview name="textarea-invalid" />

```tsx file=../../../demos/textarea/invalid.tsx title=""
