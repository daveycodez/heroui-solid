...
| `autoResize`    | `boolean`                  | `false`     | Grow the textarea to fit its content (Kobalte extra, not present upstream)                                                                                         |
| `submitOnEnter` | `boolean`                  | `false`     | Submit the enclosing form on Enter without Shift (Kobalte extra, not present upstream)                                                                             |
