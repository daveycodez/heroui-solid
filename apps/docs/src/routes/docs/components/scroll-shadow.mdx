...
```tsx file=../../../demos/scroll-shadow/default.tsx title=""
...
```tsx file=../../../demos/scroll-shadow/orientation.tsx title=""
...
```tsx file=../../../demos/scroll-shadow/hide-scroll-bar.tsx title=""
...
```tsx file=../../../demos/scroll-shadow/custom-size.tsx title=""
...
```tsx file=../../../demos/scroll-shadow/visibility-change.tsx title=""
...
```tsx file=../../../demos/scroll-shadow/with-card.tsx title=""
...
| `initialShadow`      | `boolean`                                                                          | `true`       | Assume the content overflows on SSR / first frame, so the end-edge shadow renders before client measurement. Set `false` for content unlikely to overflow, so the shadow doesn't appear then vanish on mount. |
